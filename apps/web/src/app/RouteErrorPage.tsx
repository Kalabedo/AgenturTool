  ...
  return (
    <div className="rounded-lg border border-border bg-surface p-8 text-center">
      ...
      <div className="mt-4 flex justify-center gap-3">
        ...
        <button
          type="button"
          className="rounded-md border border-border-strong bg-surface px-4 py-2 text-sm font-medium text-ink-muted hover:bg-surface-hover focus:outline-none focus-visible:ring-2 focus-visible:ring-focus"
